...
class BaseForm(QDialog):
    ...
    def __init__(self, parent):
        ...
        self.btnGuardar.setObjectName("tab-button")
...
class TaskForm(BaseForm):
    ...
    def __config(self)->None:
        ...
        self.lblId.setObjectName("tab-label")
        self.lblTaskTitle.setFont(FNTTEXTO)
        self.lblTaskTitle.setText("Titulo:")
        self.lblTaskTitle.setObjectName("tab-label")
        ...
        self.lblDesc.setObjectName("tab-label")
